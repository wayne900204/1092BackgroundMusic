package com.example.a1092backgroundservice;
...
public class WenyaService extends Service {
    ...
    public void onCreate() {
        super.onCreate();
//        將歌曲載入到MediaPlayer中
        mediaPlayer = MediaPlayer.create(this,R.raw.ifonly);
